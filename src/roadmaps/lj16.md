...
- ~~Replace exercise cable bar with climbing anchors and carabiners~~
- Mount pull-up cables from climbing anchors
- Rack with hooks along walls for hanging up accessories, cables, etc.
...
- Final sanding of timbers to clean off any plaster
- Clean construction dust from entire space with e.g. wet rag
- Mask timbers, door/window trim, plumbing, etc. in preparation for painting
- Paint plaster surfaces with a cheerful vapor-diffusive mineral (e.g. silicate) paint
