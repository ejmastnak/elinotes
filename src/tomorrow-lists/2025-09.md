...
- TV47 attic plans: take measurements of attic; draw up preliminary floor plan
- EliPortfolio: look through MC binary decoder and clean up understanding of interpretting signedness.
  ACC, GYR, MAG are probably mid-supply biased.
  Strain gauges have output balanced around the zero-strain value.
- KUGW EliPortfolio
- KUGW i18n + SSG
- Begin CMS?
- Review direction/roadmap and reorient as needed
- You could develop HisnaŠtevilka products shelf. E.g. do one a day, tomorrow start with book holders—just make a few more.
- Pick apples for Gaia pictures
- Gaia infrastructure: begin work on setting up workshop in pekarna
- Empty attic gym of construction waste
- Measure and cut steel for parallel-grip pull-up bar. Use round pipes. Then drill holes. Decide horizontal spacing. And mount.
  Or e.g. cut steel for monkey bars.
...
- Gaia teas day
- Gaia: set up miter saw in pekarna
- HisnaŠtevilka: prototype mozniki
- HisnaŠtevilka: prototype mounting with silicone caulk; prototype silicone caulk with wire lath
