...
- EliPortfolio: add graphs to TMG parameter computation write-up
- EliPortfolio: clean up code for TMG parameter computation write-up
- EliPortfolio: begin ChatTMG write-up
- TV47 Attic remodel: draw floor plan of attic in QCAD
- Evaluate Burts and takes notes for each batch
- Soap plan next steps
- Make spring mat for attic gym

## Possibilities

- Remove lingering construction waste and other garbage from Štala
- Gaia infrastructure: begin work on setting up workshop in pekarna
- Gaia teas day
