...
- ~~Bus: finalize yaml2md scripts and workflow for moving workout files to EliNotes~~
- ~~Bus: begin MiniOffice writeup~~
- ~~MuscleSync: process, filter, and run derivative and integral analysis on new meausurements~~
- ~~Gaia: investigate website to vite-ssg~~
- ~~Gaia: new apple pictures to website~~
- ~~Picture of complete TV47 attic gym; add to EliProjects and publish~~
- ~~Pictures of house signs~~
- ~~Take test pictures of jams~~
- ~~EliPortfolio: Create a VitePress site to store Portfolio, publish at `portfolio.ejmastnak.com`~~
- ~~Complete Gaia products shelf~~
- ~~Begin work on JabSok750~~
- ~~Process round of pears~~
- ~~KUGW EliPortfolio~~

## 2025-09-17

- ~~Monthly accounting, bills, bookkeeping, etc.; for Gaia and Eli~~
- ~~Pictures of Gaia products: JabSok330, JabSok750, JabKis500, JabKis1000, SntOlj100~~
- ~~EliPortfolio: draft MC binary decoder article~~
- ~~KUGW JabSok750 crates~~
- ~~Investigate possibility of plugs for countersunk screw holes~~
- ~~Begin hello-world Astro site. E.g. just set up a "Hello, world!" index page with a Foo component that you can pass a String prop to.~~
- ~~Process round of pears~~
- ~~Astro: how to install Tailwind v3~~
- ~~Astro: how to optimize images. Is there a native tool?~~

## 2025-09-18

- ~~EliPortfolio: polish and publish MC binary decoder article~~
- ~~Gaia infrastructure: cut materials for a set of sawhorses for a table in pekarna~~
- ~~Astro KUGW; investigate layout and i18n~~

## 2025-09-19

- ~~Prepare list of tools and materials for mounting Medvode hisna stevilka—dowels, screws, masonry anchors, tools, etc.~~
- ~~Gaia infrastructure: build sawhorses for pekarna~~
- ~~Find and begin documenting a recipe for i18n with SSG~~
- ~~Test: does a vite-ssg site like EliProjects work on old iPad?~~
- ~~Update MuscleSync 2025-09-16 measurement write-up~~
- ~~Pack Gaia izdelki for Ljubljana~~
- ~~Deliver HisnaŠtevilka to Matjaž and Cvetka; discuss future marketing~~

## 2025-09-20

- ~~Create site for HisnaŠtevilka with pictures, contact info, ordering information. Deploy at e.g. [hisnastevilka.ejmastnak.com](https://hisnastevilka.ejmastnak.com)~~
- ~~Review prices and prepare goods for LJ trgovina meeting~~
- ~~KUGW MiniOffice sanding ~~
- ~~Prepare shopping list for Bauhaus electrical trip~~
- ~~KUGW scripts for converting FB exercises to EliNotes~~

## 2025-09-21

- ~~LJ trgovina meeting~~
- ~~Complete infrastructure for storing Fitness Biomechanics program as YAML and building to Vitepress-ready Markdown for EliNotes~~
- ~~Bauhaus: buy materials for TV47 electrical~~
- ~~Bolha: sink, kište, and bobrovci as available~~
- ~~Ferry LJ16 attic wood to TV47~~
- ~~Develop SSG with i18n recipe~~

## 2025-09-22

- ~~EliPortfolio: look through MC binary decoder and clean up understanding and treatment of interpretting signedness.~~
- ~~TV47 attic plans: prepare list of attic measurements to take~~
- ~~KUGW EliPortfolio: begin technical write-up for TMG parameter computation~~
- ~~HisnaŠtevilka: build two prototype book holders~~
- ~~Process previous round of Gaia products pictures~~
- ~~Complete MWE i18n + SSG recipe~~
- ~~Empty attic gym of construction waste~~
- ~~Measure and cut steel for parallel-grip pull-up bar~~

## 2025-09-23

- ~~Complete documentation of MWE vite-ssg + i18n recipe~~
- ~~EliPortfolio: complete rough write-up of TMG parameter computation~~
- ~~EliPortfolio: write overview of ChatTMG technical writeup~~
- ~~EliPortfolio: publish and polish API documentation page for TMG toolkit~~
- ~~EliWorkouts: script to audit missing combos~~
- ~~Document i18n + vite-ssg recipe~~
- ~~Convert Ricky summer 2025 warm-up to EliNotes YAML format~~
- ~~TV47 attic plans: take initial floor plan measurements~~
- ~~HisnaŠtevilka: prototype mozniki~~
- ~~Attic gym: mount parallel-grip pull-up bars~~
- ~~Attic gym: Begin cutting steel tubing for monkey bars~~
- ~~CMS: research and understand viable options (headless, Git vs API-based) for my usecase and candidates to try~~

## 2025-09-24

- ~~EliPortfolio: begin graphs for TMG parameter computation write-up~~
- ~~EliPortfolio: content dump for ChatTMG write-up~~
- ~~Apply Julia's edits to jemastnak.com~~
- ~~Attic gym: spring mat for attic gym~~
- ~~Attic gym: complete cutting steel tubing for monkey bars~~
- ~~Evaluate Burts and takes notes for each batch~~
- ~~TV47 Attic remodel: plan location of bathroom and bathroom layout~~
- ~~Figure out proof-of-concept usage of Tailwind Elements with Vue and Astro; record recipes~~

## 2025-09-25

- ~~EliPortfolio: clean up writing/presentation for TMG parameter write-up~~
- ~~EliPortfolio: clean up code for TMG parameter computation write-up~~
- ~~EliPortfolio: look through SenseMotion~~
- ~~EliPortfolio: polish TMG Toolkit/SPM docs~~
- ~~EliPortfolio: TMG Toolkit/SPM presentation: re-do auth workflow to protect POST routes for SPM analysis, but to allow visits to SPM page. Similar to e.g. EliMusic.~~
- ~~EliPortfolio: first pass clean-up for ChatTMG write-up~~
- ~~Make second spring mat for attic gym~~
- ~~Move workbenches and power tools to pekarna~~
- ~~Attic gym: grind out weld joints from monkey bars~~

## 2025-09-26

- ~~EliPortfolio: prepare screenshots of TMG Toolkit/SPM~~
- ~~EliPortfolio: begin demo page with sample results for TMG Toolkit/SPM~~
- ~~Attic gym: measure beam spacing for monkey bars spacing~~
- ~~Attic renovation: cut/štema space and install conduit for three-way switch~~
- ~~KUGW moving workspace to pekarna~~
- ~~Progress with proof-of-concept i18n with Astro~~

## 2025-09-27

- ~~EliPortfolio: clean up demo page with sample results for TMG Toolkit/SPM~~
- ~~KUGW with proof-of-concept i18n with Astro~~
- ~~KUGW emptying attic~~
- ~~Attic renovation: investigate roof structure and materials under tongue-and-groove finish ceiling~~

## 2025-09-28

- ~~Complete LocaleSwitcher and link portion of i18n with Astro~~
- ~~TV47: KUGW emptying attic~~
- ~~Barel/Huguel meetings~~
- ~~Begin investigating concrete recipe for Decap CMS~~
- ~~Complete "špric" coat of pekarna wall parging~~
- ~~Follow up with Žan and Maj~~
- ~~Attic gym: drill holes for monkey bars~~

## 2025-09-29

- ~~KUGW Astro + i18n proof-of-concept setup~~
- ~~Plan out layout and materials for TV47 attic bathroom~~

## 2025-09-30

- ~~Complete Astro + i18n proof-of-concept setup~~
- ~~LJ: swap out busbar in LJ16 electrical panel~~
- ~~Complete MiniOffice rough sanding~~
- ~~Meet Maj and Oskar; discuss JabSok sales~~
