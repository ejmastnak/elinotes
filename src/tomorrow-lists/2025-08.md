...
- MuscleSync: research and understand Sparkfun library and PWM program for DRV2605L and port to Python
- Take pictures of three pear species: by klet entrance, on the road to lower travnik; by road to house
- Make Burts
- Label circuits
- Fruit processing family session
- Sketch out a plan for jasen garden table; present to Dad
- Begins steps on VitePress port of EliProjects: how can you use custom Vue pages and components in VitePress?
- Investigate putting generic Ricky material that does not have 2018 PDFs on EliNotes

Next at LJ16:

- Bring back Mom car key from LJ16!
