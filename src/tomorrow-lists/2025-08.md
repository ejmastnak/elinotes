...
- Add Zgodnja Ledrovka (Sentjakobka to Gaia apples website)
- Sync music library onto attic iPad FooBar
...
- Move Gaia email to new address and server I control
- Review EliPortfolio roadmap and draft next steps
- Mom car key
- Plane changing blades
...
- Light from attic to use for nightlight
